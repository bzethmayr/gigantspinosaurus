...
import static net.bzethmayr.gigantspinosaurus.model.Framing.FRAME_FIELD;
...
public record Orientation(
    ...
    public Orientation(double QW,
                       ...
                       double QZ,
                       Framing framing) {
        this(QW, QX, QY, QZ, framing, (short) 0);
    }
    ...
    private static final BoundAttributes<Orientation> ACCESSORS = new BoundAttributes<>(
            ...
            adds("frame", fromConverted(Orientation::framing, Framing::canonicalBytes)),
    ...
    public Orientation withQ4(final double[] q4) {
        return new Orientation(q4[0], q4[1], q4[2], q4[3], framing, (short) 0);
    }

    public Orientation withFrame(final Framing obtained) {
