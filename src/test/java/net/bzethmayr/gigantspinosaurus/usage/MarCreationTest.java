...
class MarCreationTest implements TestsModel, TestsWithBytes {
    ...
    void intentToRecord_givenIntentFrame_againstDesktopBindings_returnsRoundTripReceiver() {
        ...
        assertNotNull(intentFrame.media());
        assertEquals(noStep(), intentFrame.media().r0());
        assertEquals(0, intentFrame.media().BLK3()[0]);
        assertEquals(0, intentFrame.media().BLK3()[MEDIA_HASH_BYTES - 1]);
        ...
        assertNotNull(firstFrame.media());
        ...
        assertNotNull(secondFrame.media());
